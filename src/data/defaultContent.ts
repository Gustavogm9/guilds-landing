...
// Default fallback content for Guilds website
// Used when database content is unavailable or loading
...
const evaluationFramework = {
    quadrants: [
        ...
        {
            tools: ["React", "Next.js", "Flutter", "PWAs", "Mobile", "Bubble", "Trae"]
        }
    ],
    process: [
        {
...
const automationFAQ = [
    ...
    {
        question: "Como garantem a segurança dos dados na automação?",
