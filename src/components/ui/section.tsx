...
const HeroSection = React.forwardRef<HTMLElement, Omit<SectionProps, 'spacing' | 'container'>>(({
  className,
  ...props
}, ref) => <Section ref={ref} spacing="lg" container="wide" className={cn("min-h-[75vh] flex items-center", className)} {...props} />);
HeroSection.displayName = "HeroSection";
const ContentSection = React.forwardRef<HTMLElement, Omit<SectionProps, 'spacing'>>(({
  className,
  ...props
}, ref) => <Section ref={ref} spacing="md" className={className} {...props} />);
ContentSection.displayName = "ContentSection";
const FeatureSection = React.forwardRef<HTMLElement, Omit<SectionProps, 'background' | 'container'>>(({
  className,
  ...props
}, ref) => <Section ref={ref} background="muted" container="wide" className={className} {...props} />);
FeatureSection.displayName = "FeatureSection";
export { Section, sectionVariants, HeroSection, ContentSection, FeatureSection };